...
public class UISoundSFXSlider : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        SetValueWithoutNotify(SoundManager.Instance.VolumeSFX);
        SetInteractable(!SoundManager.Instance.MuteSFX);
        SoundManager.Instance.AddSFXSlider(this);
    }

    private void OnDestroy()
    {
        if (SoundManager.Instance == null) return;
        SoundManager.Instance.RemoveSFXSlider(this);
    }
